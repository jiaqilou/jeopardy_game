...
private static HashMap<Class<?>, Action> actionMap;
	...
	public ActionFactory(){
		...
		if (actionMap == null){
			...
			actionMap.put(TimeforOtherChooseQuesMessage.class, new NextTeamChooseAction());
			actionMap.put(TimeOutChooseQuesMessage.class, new TimeOutChooseQuesAction());
			actionMap.put(NoBuzzInMessage.class, new NoBuzzInAction());
		}
	}
	
	public Action getAction(Class<?> messageClass){
		return (Action) actionMap.get(messageClass);
	}
